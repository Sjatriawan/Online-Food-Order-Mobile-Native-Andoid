...
public class MyOrderDetailAdapter extends RecyclerView.Adapter<MyOrderDetailAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        try {
            ...
            if (sizeModel != null)
                holder.txt_size.setText(new StringBuilder("Jumlah: ").append(sizeModel.getName()));
...
//                holder.txt_food_add_on.setText(new StringBuilder(" ").append(addonString));
            }
        }else
            holder.txt_food_add_on.setText(new StringBuilder(""));
