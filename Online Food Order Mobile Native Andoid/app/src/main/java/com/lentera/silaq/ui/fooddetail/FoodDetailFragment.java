...
import com.lentera.silaq.Model.OngkirModel;
import com.lentera.silaq.Model.SizeModel;
import com.lentera.silaq.R;
import com.lentera.silaq.ui.comments.CommentFragment;
...
public class FoodDetailFragment extends Fragment implements TextWatcher {
    ...
    private OngkirModel ongkirModel = new OngkirModel();
                ...
                .subscribe(new SingleObserver<CartItem>() {
                    ...
                    public void onSuccess(CartItem cartItemFromDB) {
                        if(cartItemFromDB.equals(cartItem)){
                            //sudah ada dalam DB tinggal update
                            ...
                            cartDataSource.updateCartItem(cartItemFromDB)
                                    ...
                                    .subscribe(new SingleObserver<Integer>() {
                                        ...
                                        public void onSuccess(Integer integer) {
                                            Toast.makeText(getContext(),"Update Keranjang berhasil",Toast.LENGTH_SHORT).show();
                            ...
                            compositeDisposable.add(cartDataSource.insertOrReplaceAll(cartItem)
                                    ...
                                    .subscribe(()->{
                                        ...
                                        Toast.makeText(getContext(),"Gagal menambahkan"+throwable.getMessage(), Toast.LENGTH_SHORT).show();
                                    }));
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        if(e.getMessage().contains("empty"))
                        {
                            compositeDisposable.add(cartDataSource.insertOrReplaceAll(cartItem)
                                    ...
                                    .observeOn(AndroidSchedulers.mainThread())
                                    .subscribe(()->{
                                        Toast.makeText(getContext(), "Sukses menambahkan ke keranjang", Toast.LENGTH_SHORT).show();
                                        EventBus.getDefault().postSticky(new CounterCartEvent(true));
                                    },throwable -> {
                                        Toast.makeText(getContext(),"[Keranjang Error]"+throwable.getMessage(), Toast.LENGTH_SHORT).show();
                                    }));
                        }else
    ...
    private void showDialogRating() {
        ...
        builder.setPositiveButton("OK", (dialog, which) -> {
            ...
            Map<String, Object> serverStamp = new HashMap<>();
            serverStamp.put("timeStamp", ServerValue.TIMESTAMP);
            commentModel.setCommentTimeStamp(serverStamp);
        ...
        Common.selectedFood.getUserSelectedAddon().size()>0){
            ...
            for(AddonModel addonModel: Common.selectedFood.getUserSelectedAddon()){
                ...
                chip.setOnCloseIconClickListener(v -> {
                    //Hapus ketika user pilih delete
...
//
    ...
    private void displaInfo(FoodModel foodModel) {
...
//            rdi_group_size.addView(radioButton);
    ...
    private void calculateTotalPrice() {
        ...
        ongkirModel.setOngkir(-1);
        displayPrice=totalPrice+(Integer.parseInt(numberButton.getNumber())+ongkirModel.getOngkir());
