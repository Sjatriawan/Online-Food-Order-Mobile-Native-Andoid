...
public class LocalCartDataSource implements CartDataSource {
    ...
    @Override
    public Single<CartItem> getItemInWithAllOptionCart( String foodId,String uid,String  foodSize, String foodAddon) {
        return cartDAO.getItemInWithAllOptionCart(uid,foodId,foodSize,foodAddon);
    }
}
